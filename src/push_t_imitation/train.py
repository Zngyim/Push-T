...
from push_t_imitation.data import (
    Normalizer,
    PushtChunkDataset,
    download_pusht,
    load_pusht_zarr,
)
from push_t_imitation.model import build_policy, PolicyType
from push_t_imitation.evaluation import Logger
from push_t_imitation.evaluation import evaluate_policy
...
class TrainConfig:
    ...
    seed: int = 42
    # WandB project name.
    wandb_project: str = "push_t_imitation"
